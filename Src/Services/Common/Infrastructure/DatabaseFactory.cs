...
namespace Infrastructure
{
        ...
        where TDbContext : DbContext
    {
        ...
        protected DatabaseFactory(string databaseType, IOptions<DbConfiguration> dbConfigurationOptions,
            ILoggerFactory loggerFactory) : base(databaseType, dbConfigurationOptions, loggerFactory)
        {
        }
        ...
        /// <param name="loggerFactory">The logger factory.</param>
        protected DatabaseFactory(string databaseType, DbConfiguration dbConfiguration, ILoggerFactory loggerFactory) :
            base(databaseType, dbConfiguration, loggerFactory)
        {
        }
